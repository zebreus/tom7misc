...
Evaluator::Evaluator(EmulatorPool *emulator_pool, const Emulator *src_emu) {
...
int Evaluator::HowSolved(const Emulator *emu) const {
...
bool Evaluator::IsDead(const Emulator *emu) const {
...
bool Evaluator::Stuck(const Emulator *emu) const {
...
double Evaluator::Eval(const Emulator *emu) const {
