...
static enum eLinearSolution Show(const BigInteger *num, const char *str, enum eLinearSolution t);
...
static eLinearSolution Show(const BigInteger *num, const char *str, enum eLinearSolution t)
{
...
void SolveQuadModEquation(void)
{
  ...
  SolveEquation(
      SolutionX, ShowSolutionsModPrime, NoSolsModPrime,
...
static eLinearSolution LinearEq(
